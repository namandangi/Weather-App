...
export default class History extends Component{
	...
	loadData = async() => {
		...
		content.map((el, id) => {
			tempdata[id] = el;
			tempicon[id] = this.iconList[el.weather[0].icon] || logo;
		})
		this.setState({ data: tempdata, icon: tempicon });
	}
	componentWillMount() {
		this.loadData();
	}
	...
	render() {		
		return(
			...
			<h1 style={{ fontFamily: "Helvetica, sans-serif" ,fontSize: 50, fontWeight: 600, color: 'white' }}>HISTORY</h1>
				...
				<div className="data">
					<div className="bottomLeft">
						<div className="imgbox">
							<img src={this.state.icon[id]} style={{ width: 370, height: 300 }}/>
						</div>
